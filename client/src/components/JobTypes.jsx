    ...
    <div className='w-full'>
      <Listbox value={jobTitle} onChange={setJobTitle}>
        <div className='relative'>
          <Listbox.Button className='relative w-full cursor-default rounded bg-[#eee] py-2.5 pl-3 pr-10 text-left focus:outline-none border border-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500  sm:text-sm'>
                ...
                <Listbox.Option
                  ...
                  className={({ active }) =>
                    `relative cursor-default select-none py-2 pl-10 pr-4 ${
                      active ? "bg-amber-00 text-amber-900" : "text-gray-900"
                    }`
                  }
                  value={type}
                >

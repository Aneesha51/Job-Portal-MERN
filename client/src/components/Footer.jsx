...
const Footer = () => {
  return (
    <footer className='text-white mp-20'>
      <div className='overflow-x-hidden -mb-0.5 bg-[#eee]'>
        <svg
      ...
      <div className='bg-[#1d4ed8] '>
        ...
        <div className=''>
            <span className='inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center gap-3 textmd:w-auto'>
              <a className='text-white text-xl  hover:scale-125 ease-in-out duration-300'>
                <FaFacebookF href="#" target="_blank"/>
              </a>
              <a className='ml-3 text-white text-xl  hover:scale-125 ease-in-out duration-300'>
                <FaTwitter href="#" target="_blank"/>
              </a>
              <a className='ml-3 text-white text-xl  hover:scale-125 ease-in-out duration-300'>
                <FiInstagram href="#" target="_blank" rel="noreferrer noopener"/>
              </a>

              <a className='ml-3 text-white text-xl  hover:scale-125 ease-in-out duration-300'>
                <FaLinkedinIn href="#" target="_blank"/>
              </a>
            </span>
          </div>
        </div>

        <div className='bg-[#020d19]'>
          <div className='container mx-auto py-4 px-5 justify-center sm:flex-row'>
            <p className='text-gray-300 text-sm text-center sm:text-left'>
              &copy; copy right @ 2024 by Employment Seeker
              <a
                href='#'

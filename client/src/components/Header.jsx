...
const Header = ({
  ...
  return (
    <div className='bg-[#eee]'>
      <div
        className={`container mx-auto px-5 pl-10 ${
      ...
      >
        <div className='w-full z-10'>
          ...
          <div className='w-full flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-md'>
            <SearchInput
              placeholder='Job Title or Keywords'
              icon={<AiOutlineSearch className='text-gray-800 text-xl ' />}
              value={searchQuery}
          ...
          {type && (
            <div className='w-full lg:1/2 flex flex-wrap gap-3 md:gap-6 py-10 md:py-14 ml-10 '>
              {popularSearch.map((search, index) => (
                <span
                  key={index}
                  className='bg-[#1d4fd826] text-[#1d4ed8] py-1 px-2 rounded-md text-sm md:text-base'
                >
                  {search}
                </span>
              ))}
        ...
        <div className='w-1/3 h-full absolute mt-10 top-25 md:-top-6 lg:-top-15 right-16 2xl:right-[-2rem]'>

...
const UploadJob = () => {
  ...
  return (
    <div className='container mx-auto flex flex-col md:flex-row gap-8 2xl:gap-14 bg-[#eee] px-5 pt-5'>
      <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-[#eee] px-5 py-10 md:px-10 shadow-lg'>
        <div>
          <p className='text-gray-800 font-semibold text-2xl'>Job Post</p>
